...
__all__ = [ 'OLE_YPOS_PIXELS', 'LoadPictureConstants', 'StdFont',
           'OLE_YSIZE_PIXELS', 'OLE_YSIZE_CONTAINER', 'Picture',
           'OLE_XSIZE_HIMETRIC', 'Color', 'IPictureDisp',
           'OLE_XPOS_PIXELS', 'OLE_TRISTATE', 'OLE_XPOS_CONTAINER',
           'Monochrome', 'Unchecked', 'IFontDisp',
           'OLE_XPOS_HIMETRIC', 'FONTUNDERSCORE', 'FONTSTRIKETHROUGH',
           'OLE_YPOS_CONTAINER', 'FONTITALIC', 'OLE_CANCELBOOL',
           'OLE_YPOS_HIMETRIC', 'Font', 'OLE_COLOR', 'Default',
           'IPicture', 'OLE_HANDLE', 'IFont', 'OLE_XSIZE_CONTAINER',
           'OLE_XSIZE_PIXELS', 'FONTSIZE', 'StdPicture', 'VgaColor',
           'FONTBOLD', 'OLE_OPTEXCLUSIVE', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YSIZE_HIMETRIC', 'FontEvents', 'Checked',
           'IFontEventsDisp', 'Gray', 'FONTNAME']
from comtypes import _check_version; _check_version('1.1.9', 1575709685.550032)
